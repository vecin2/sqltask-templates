...
instance_verbs_by_ed=SELECT V.NAME,IDMAP.KEYNAME FROM EVA_VERB V, CCADMIN_IDMAP IDMAP where V.ENTITY_DEF_ID = @ED.{} AND IDMAP.KEYSET='V' AND IDMAP.ID =V.ID V.IS_INSTANCE ='Y';
