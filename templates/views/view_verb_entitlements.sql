...
LEFT JOIN LOCALISED_FIELD ld on ld.OBJECT_TYPE='EntitlementED' and ld.FIELD_NAME='displayName' and ee.SYSTEM_NAME = ld.OBJECT_INSTANCE and ld.LOCALE='{{default_locale}}'
