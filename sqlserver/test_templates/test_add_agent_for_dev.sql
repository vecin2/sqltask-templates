...
VALUES ('ccagentdemo2','0ef489f','John Demo',2075-15-12,@USER.ccagentdemo2,1,'no',0,CURRENT_TIMESTAMP,1,'no',0,CURRENT_TIMESTAMP,'wkhvmgQLLhY=','com.gtnet.common.security.algorithms.SHA256','no','default');
...
set PASSWORD = (select PASSWORD from AGENT where username ='admin'),
 ...
 DISABLED ='no',
 LASTLOGGEDIN = CURRENT_TIMESTAMP
