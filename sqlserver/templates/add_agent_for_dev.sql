...
VALUES ('{{username}}','0ef489f','{{name}} {{surname}}',2075-15-12,@USER.{{username}},1,'no',0,CURRENT_TIMESTAMP,1,'no',0,CURRENT_TIMESTAMP,'wkhvmgQLLhY=','com.gtnet.common.security.algorithms.SHA256','no','default');
